...
private:
	...
	double permitted_absolute_error_;
	...
	double permitted_relative_error_;
...
public:
	...
	// and 0 permitted_absolute_error_ and 0 permitted_relative_error_
	NumericalQuestion();
	...
	//Changes the permitted_absolute_error_ to set_permitted_absolute_error
	void   SetPermittedAbsoluteError(double set_permitted_absolute_error);

	//Returns the current permitted_absolute_error_
	double GetPermittedAbsoluteError() const;

	//Changes the permitted_relative_error_ to set_permitted_relative_error
	void   SetPermittedRelativeError(double set_permitted_relative_error);

	//Returns the current permitted_relative_error_
	...
	//An answer is right if its absolute error (|correct_answer - student answer|) is less than permitted_absolute_error_
	//and its relative error  (|correct_answer - student answer| / |correct_answer|) is less than permitted_relative_error_
